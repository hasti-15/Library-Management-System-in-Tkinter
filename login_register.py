...
class login:
     ...
     def loginfn(self):#login page design for student adn libraran

        self.label = Label(self.frame,text='LIBRARY SYSTEM',font=('Georgia',15,'bold'))
        self.name = Label(self.frame,text='Username: ',font=('Arial',18,'bold'))
        self.namee_text=StringVar()
        self.namee = Entry(self.frame,textvariable=self.namee_text,fg='Black',width=25,font=('Arial',16,'bold'))
        self.password1 = Label(self.frame,text='Password : ',fg='Black',font=('Arial',18,'bold'))
        ...
        if self.flag !=0:
            self.buttonAdmin = Button(self.frame,text='Librarian',bg='gray',fg='gray12',font=('Georgia',18,'bold'),cursor='hand2', command=self.adminbutton2)
        else:
            self.buttonAdmin = Button(self.frame,text='Librarian',bg='gray',fg='gray12',font=('Georgia',18,'bold'),cursor='hand2', command=self.adminbutton)
        self.buttonStudent = Button(self.frame,text='Student',bg='gray',fg='gray12',font=('Georgia',18,'bold'),cursor='hand2', command=self.studentbutton)
	# placing
     ...
     def register(self):# student registration 
         ...
         self.idre = Entry(self.frame,textvariable=self.rollno_text,fg='Black',width=25,font=('Arial',12,'bold'))
         self.passwordr1 = Label(self.frame,text='Password : ',fg='Black',font=('Arial',14,'bold'))
         ...
         self.passwordr2 = Label(self.frame,text='Re-enter Password : ', fg='Black',font=('Arial',14,'bold'))
     ...
     def create(self):#checking if all details are entered or not
     ...
     def studentbutton(self):
        ...
        self.name = Label(self.frame,text='Name: ',font=('Arial',18,'bold'))
        self.name.place(x=100,y=140,width=240,height=60)
